...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo e(url('public/ampleadmin')); ?>/css/colors/blue.css" id="theme"  rel="stylesheet">
...
<section id="wrapper" class="login-register">
    <div class="login-box login-sidebar">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" action="<?php echo e(url('admin/login')); ?>" method="post">
                <?php echo e(csrf_field()); ?>


                <a href="javascript:void(0)" class="text-center db">
                    <img src="<?php echo e(url('public/ampleadmin')); ?>/plugins/images/admin-logo-dark.png" alt="Home" /><br/>
                    <img src="<?php echo e(url('public/ampleadmin')); ?>/plugins/images/admin-text-dark.png" alt="Home" />
                </a>
